...
class BeamSearchNode(object):
    ...
    def __init__(self, search, emb, lstm_out, final_hidden, final_cell, mask, sequence, logProb, length, squared_sum=0):
        ...
        self.logp = logProb
        self.length = length
        self.squared_sum = squared_sum # Add squared_sum as an attribute

        self.search = search

    def eval(self, alpha=0.0, lambda_regularizer=0.5): # Add an argument lambda_regularizer
        ...
        regularized_score = self.logp - lambda_regularizer * self.squared_sum  # Add the regularizer
        return regularized_score / normalizer